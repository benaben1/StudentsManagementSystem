...
courseUnits = Blueprint('courseUnits', __name__,url_prefix="/courseUnits")


@courseUnits.route('/api/v1/courseUnit', methods=['GET'])
def getTutors():
    get_CourseUnits = CourseUnit.query.all()
    courseUnit_schema = CourseUnitchema(many=True)
